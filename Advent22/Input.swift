...
class Input {
    public static let Example1Hint: [[Hint]] = [
        [], // 0
        [], // 1
        [ // 2
            Hint(next: 5, position: "T", flip: false), // left
            Hint(next: 4, position: "T", flip: true), // top
            Hint(next: 11, position: "R", flip: true), // right
            Hint(next: 6, position: "T", flip: false), // bottom
        ],
        [], // 3
        [ // 4
            Hint(next: 11, position: "B", flip: true), // left
            Hint(next: 2, position: "T", flip: true), // top
            Hint(next: 5, position: "L", flip: false), // right
            Hint(next: 10, position: "B", flip: true), // bottom
        ],
        [ // 5
            Hint(next: 4, position: "R", flip: false), // left
            Hint(next: 2, position: "L", flip: false), // top
            Hint(next: 6, position: "L", flip: false), // right
            Hint(next: 10, position: "L", flip: true), // bottom
        ],
        [ // 6
            Hint(next: 5, position: "R", flip: false), // left
            Hint(next: 2, position: "B", flip: false), // top
            Hint(next: 11, position: "T", flip: true), // right
            Hint(next: 10, position: "T", flip: false), // bottom
        ],
        [], // 7
        [], // 8
        [], // 9
        [ // 10
            Hint(next: 5, position: "B", flip: true), // left
            Hint(next: 6, position: "B", flip: false), // top
            Hint(next: 11, position: "L", flip: false), // right
            Hint(next: 4, position: "B", flip: true), // bottom
        ],
        [ // 11
            Hint(next: 10, position: "R", flip: false), // left
            Hint(next: 6, position: "R", flip: true), // top
            Hint(next: 2, position: "R", flip: true), // right
            Hint(next: 4, position: "L", flip: true), // bottom
        ],
    ]
...
"""
    ...
    public static let Input1Hint: [[Hint]] = [
        [], // 0
        [ // 1
            Hint(next: 6, position: "L", flip: true), // left
            Hint(next: 9, position: "L", flip: false), // top
            Hint(next: 2, position: "L", flip: false), // right
            Hint(next: 4, position: "T", flip: false), // bottom
        ],
        [ // 2
            Hint(next: 1, position: "R", flip: false), // left
            Hint(next: 9, position: "B", flip: false), // top
            Hint(next: 7, position: "R", flip: true), // right
            Hint(next: 4, position: "R", flip: false), // bottom
        ],
        [], // 3
        [ // 4
            Hint(next: 6, position: "T", flip: false), // left
            Hint(next: 1, position: "B", flip: false), // top
            Hint(next: 2, position: "B", flip: false), // right
            Hint(next: 7, position: "T", flip: false), // bottom
        ],
        [], // 5
        [ // 6
            Hint(next: 1, position: "L", flip: true), // left
            Hint(next: 4, position: "L", flip: false), // top
            Hint(next: 7, position: "L", flip: false), // right
            Hint(next: 9, position: "T", flip: false), // bottom
        ],
        [ // 7
            Hint(next: 6, position: "R", flip: false), // left
            Hint(next: 4, position: "B", flip: false), // top
            Hint(next: 2, position: "R", flip: true), // right
            Hint(next: 9, position: "R", flip: false), // bottom
        ],
        [], // 8
        [ // 9
            Hint(next: 1, position: "T", flip: false), // left
            Hint(next: 6, position: "B", flip: false), // top
            Hint(next: 7, position: "B", flip: false), // right
            Hint(next: 2, position: "T", flip: false), // bottom
        ],
        [], // 10
        [], // 11
    ]
